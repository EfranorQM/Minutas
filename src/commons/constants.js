...
export const NATIVE_URL = 'http://localhost:8300/';
// export const NATIVE_URL = 'https://bomberos-api.herokuapp.com';

export const API_URL = 'http://localhost:8300/api';
...
export const ROUTES = {
  personal: {
    ...
    unidadesBomberiles: '/unidades-bomberiles',
    persons: '/personas',
...
export const MENU = [
  {
    ...
    options: [
      ...
      {
        name: 'Unidades Bomberiles',
        link: ROUTES.personal.unidadesBomberiles,
      },
      {
        name: 'Personas',
